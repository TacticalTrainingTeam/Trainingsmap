#define leader_pic				"W_Teleporter\data\isLeader.paa"
#define vehicle_pic 			"W_Teleporter\data\isInVehicle.paa"
#define leader_vehicle_pic 		"W_Teleporter\data\isCombined.paa"
