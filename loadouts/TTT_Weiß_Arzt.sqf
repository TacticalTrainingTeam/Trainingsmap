...
_unit forceAddUniform "TTT_Uniform_White_BW_Flecktarn";
_unit addVest "TTT_Vest_Crew_White";
...
for "_i" from 1 to 16 do {_unit addItemToBackpack "ACE_elasticBandage";};
for "_i" from 1 to 16 do {_unit addItemToBackpack "ACE_packingBandage";};
