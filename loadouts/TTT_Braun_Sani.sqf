...
for "_i" from 1 to 3 do {_unit addItemToVest "kat_Pulseoximeter";};
...
for "_i" from 1 to 3 do {_unit addItemToBackpack "kat_pocketBVM";};
for "_i" from 1 to 6 do {_unit addItemToBackpack "kat_ncdKit";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "kat_larynx";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "kat_IV_16";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "kat_chestSeal";};
for "_i" from 1 to 12 do {_unit addItemToBackpack "ACE_epinephrine";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "ACE_morphine";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "kat_naloxone";};
