...
player addHeadgear "TTT_Beret_black";
...
for "_i" from 1 to 2 do {player addItemToVest "30Rnd_556x45_Stanag_Tracerblack";};
...
for "_i" from 1 to 16 do {player addItemToBackpack "1Rnd_HE_Grenade_shell";};

[player, "arifle_SPAR_01_GL_blk_F", 6, 2] call BIS_fnc_addWeapon;
