...
class andxRscShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
...
class andxRscButtonMenuCancel
{
	idc = 2;
	shortcuts[] = {"0x00050000 + 1"};
	text = "Cancel";
};
class andxRscControlsGroup
{
	deletable = 0;
	fade = 0;
	class VScrollbar 
...
class andx_loadouts {
	...
	class controls {
		...
		class andx_button_2: andxRscButton
		{
			...
			h = 0.044 * safezoneH;
			tooltip = "gewähltes Loadout ausrüsten"; //--- ToDo: Localize;
			action = "[] spawn {execVM 'andx_loadouts\a_action.sqf';};";
		};
