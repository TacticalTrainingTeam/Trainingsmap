if (hasInterface) then {
    ...
    [
        ...
        {   
            ...
            _target setVariable ["target_range_isUp_cqb1", false, true];
            _target setVariable ["target_range_abort_cqb1", true, true];
            _argv spawn TargetRange_fnc_triggerTargets_cqb1;
            hint "Übungsende, Übungsende!";
        },
        {   
            params ["_target", "_caller"];
            _target getVariable ["target_range_isUp_cqb1", false]
        },
        {},
    ...
    [
        ...
        {
            params ["_target", "_caller", "_argv"];
            _target setVariable ["target_range_isUp_cqb1", true, true];
            _target setVariable ["target_range_abort_cqb1", false, true];
            _argv spawn TargetRange_fnc_triggerTargets_cqb1;
            hint "Übungsbeginn!";
        },
        {
