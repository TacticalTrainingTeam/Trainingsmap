...
if (hasInterface) then {
    ...
    [
        ...
        {
            {
                trigger_cqb_p_5_1 enableSimulationGlobal true;
                missionNamespace setVariable ["reim_parcour_available_cqb_p_5", false, true];
            } remoteExec ["bis_fnc_call",2];
            hint "Übungsbeginn!";
        },
        {
            missionNamespace getVariable ["reim_parcour_available_cqb_p_5", true]
        }
    ...
    [
        ...
        "",
        {
            [] remoteExec ["Reim_parcour_fnc_init_cqb_p_5",2];
            missionNamespace setVariable ["reim_parcour_available_cqb_p_5", true, true];
            hint "Übungsende, Übungsende!";
        },
        {
            !(missionNamespace getVariable ["reim_parcour_available_cqb_p_5", false])
        }
    ] call ace_interact_menu_fnc_createAction;
